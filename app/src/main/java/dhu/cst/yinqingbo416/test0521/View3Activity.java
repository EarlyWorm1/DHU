...
public class View3Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        glPanorama = findViewById(R.id.view3_GLPanorama);
        left = findViewById(R.id.view3_left);
        straight = findViewById(R.id.view3_straight);
        initViewsLayout();
        glPanorama.setGLPanorama(R.drawable.view3);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.view3_left:
                startActivity(new Intent(View3Activity.this,View6Activity.class));
                break;
            case R.id.view3_straight:
                startActivity(new Intent(View3Activity.this,View2Activity.class));
                break;
        }
        finish();
    }
    ...
    public void initViewsLayout(){
        Tools.setViewIndex(2);
        viewBtn = findViewById(R.id.view3_views);
        viewsLayout = findViewById(R.id.view3_switch_view);
        viewsLayout.getBackground().setAlpha(76);
        recyclerView = findViewById(R.id.view3_recyclerView);
        ...
        SceneAdapter adapter = new SceneAdapter(Tools.getSceneList(),View3Activity.this);
        recyclerView.setAdapter(adapter);
    }
    //侧边栏功能初始化
    private void initSidebar(){
        sideBarShow = findViewById(R.id.view3_show);
        sideBar = findViewById(R.id.view3_sidebar);
        introduce = findViewById(R.id.view3_introduce);
        report = findViewById(R.id.view3_tts);
        iat = findViewById(R.id.view3_iat);
        sidebarHide = findViewById(R.id.view3_hide);
        introduceText = findViewById(R.id.view3_introduce_text);
    ...
    private void initImgCut(){
        imgCut = findViewById(R.id.view3_img);
                ...
                case 11102:
                    if (data != null) {
                        ...
                        try {
                            ...
                            Tools.switchActivity(View3Activity.this,ret);
