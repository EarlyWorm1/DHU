...
public class View5Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        glPanorama = findViewById(R.id.view5_GLPanorama);
        right = findViewById(R.id.view5_right);
        initViewsLayout();
        glPanorama.setGLPanorama(R.drawable.view5);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.view5_right:
                startActivity(new Intent(View5Activity.this,View4Activity.class));
                finish();
                break;
        }
    }
    ...
    public void initViewsLayout(){
        Tools.setViewIndex(4);
        viewBtn = findViewById(R.id.view5_views);
        viewsLayout = findViewById(R.id.view5_switch_view);
        viewsLayout.getBackground().setAlpha(76);
        recyclerView = findViewById(R.id.view5_recyclerView);
        ...
        SceneAdapter adapter = new SceneAdapter(Tools.getSceneList(),View5Activity.this);
        recyclerView.setAdapter(adapter);
    }
    //侧边栏功能初始化
    private void initSidebar(){
        sideBarShow = findViewById(R.id.view5_show);
        sideBar = findViewById(R.id.view5_sidebar);
        introduce = findViewById(R.id.view5_introduce);
        report = findViewById(R.id.view5_tts);
        iat = findViewById(R.id.view5_iat);
        sidebarHide = findViewById(R.id.view5_hide);
        introduceText = findViewById(R.id.view5_introduce_text);
    ...
    private void initImgCut(){
        imgCut = findViewById(R.id.view5_img);
                ...
                case 11102:
                    if (data != null) {
                        ...
                        try {
                            ...
                            Tools.switchActivity(View5Activity.this,ret);
