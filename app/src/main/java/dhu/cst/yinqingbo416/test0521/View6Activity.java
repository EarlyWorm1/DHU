...
public class View6Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        glPanorama = findViewById(R.id.view6_GLPanorama);
        right = findViewById(R.id.view6_right);
        initViewsLayout();
        glPanorama.setGLPanorama(R.drawable.view6);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.view6_right:
                startActivity(new Intent(View6Activity.this,View3Activity.class));
                finish();
                break;
        }
    }
    ...
    public void initViewsLayout(){
        Tools.setViewIndex(5);
        viewBtn = findViewById(R.id.view6_views);
        viewsLayout = findViewById(R.id.view6_switch_view);
        viewsLayout.getBackground().setAlpha(76);
        recyclerView = findViewById(R.id.view6_recyclerView);
        ...
        SceneAdapter adapter = new SceneAdapter(Tools.getSceneList(),View6Activity.this);
        recyclerView.setAdapter(adapter);
    }
    //侧边栏功能初始化
    private void initSidebar(){
        sideBarShow = findViewById(R.id.view6_show);
        sideBar = findViewById(R.id.view6_sidebar);
        introduce = findViewById(R.id.view6_introduce);
        report = findViewById(R.id.view6_tts);
        iat = findViewById(R.id.view6_iat);
        sidebarHide = findViewById(R.id.view6_hide);
        introduceText = findViewById(R.id.view6_introduce_text);
    ...
    private void initImgCut(){
        imgCut = findViewById(R.id.view6_img);
                ...
                case 11102:
                    if (data != null) {
                        ...
                        try {
                            ...
                            Tools.switchActivity(View6Activity.this,ret);
