...
public class View2Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        glPanorama = findViewById(R.id.view2_GLPanorama);
        straight = findViewById(R.id.view2_straight);
        retreat = findViewById(R.id.view2_retreat);
        right = findViewById(R.id.view2_right);
        initViewsLayout();
        glPanorama.setGLPanorama(R.drawable.view2);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.view2_straight:
                startActivity(new Intent(View2Activity.this,View1Activity.class));
                break;
            case R.id.view2_retreat:
                startActivity(new Intent(View2Activity.this,View4Activity.class));
                break;
            case R.id.view2_right:
                startActivity(new Intent(View2Activity.this,View3Activity.class));
                break;
        }
        finish();
    }
    ...
    public void initViewsLayout(){
        Tools.setViewIndex(1);
        viewBtn = findViewById(R.id.view2_views);
        viewsLayout = findViewById(R.id.view2_switch_view);
        viewsLayout.getBackground().setAlpha(76);
        recyclerView = findViewById(R.id.view2_recyclerView);
        ...
        SceneAdapter adapter = new SceneAdapter(Tools.getSceneList(),View2Activity.this);
        recyclerView.setAdapter(adapter);
    }
    //侧边栏功能初始化
    private void initSidebar(){
        sideBarShow = findViewById(R.id.view2_show);
        sideBar = findViewById(R.id.view2_sidebar);
        introduce = findViewById(R.id.view2_introduce);
        report = findViewById(R.id.view2_tts);
        iat = findViewById(R.id.view2_iat);
        sidebarHide = findViewById(R.id.view2_hide);
        introduceText = findViewById(R.id.view2_introduce_text);
    ...
    private void initImgCut(){
        imgCut = findViewById(R.id.view2_img);
                ...
                case 11102:
                    if (data != null) {
                        ...
                        try {
                            ...
                            Tools.switchActivity(View2Activity.this,ret);
