...
public class View7Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        glPanorama = findViewById(R.id.view7_GLPanorama);
        left = findViewById(R.id.view7_left);
        initViewsLayout();
        glPanorama.setGLPanorama(R.drawable.view7);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.view7_left:
                startActivity(new Intent(View7Activity.this,View4Activity.class));
                finish();
                break;
        }
    }
    ...
    public void initViewsLayout(){
        Tools.setViewIndex(6);
        viewBtn = findViewById(R.id.view7_views);
        viewsLayout = findViewById(R.id.view7_switch_view);
        viewsLayout.getBackground().setAlpha(76);
        recyclerView = findViewById(R.id.view7_recyclerView);
        ...
        SceneAdapter adapter = new SceneAdapter(Tools.getSceneList(),View7Activity.this);
        recyclerView.setAdapter(adapter);
    }
    //侧边栏功能初始化
    private void initSidebar(){
        sideBarShow = findViewById(R.id.view7_show);
        sideBar = findViewById(R.id.view7_sidebar);
        introduce = findViewById(R.id.view7_introduce);
        report = findViewById(R.id.view7_tts);
        iat = findViewById(R.id.view7_iat);
        sidebarHide = findViewById(R.id.view7_hide);
        introduceText = findViewById(R.id.view7_introduce_text);
    ...
    private void initImgCut(){
        imgCut = findViewById(R.id.view7_img);
                ...
                case 11102:
                    if (data != null) {
                        ...
                        try {
                            ...
                            Tools.switchActivity(View7Activity.this,ret);
